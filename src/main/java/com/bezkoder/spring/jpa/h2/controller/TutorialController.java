...
public class TutorialController {
   ...
   *
   * @param title (optional) Title to filter the tutorials.
   * @return List of tutorials or status indicating no content.
   */
   ...
   * @return Tutorial data or a status indicating not found.
   */
   ...
   * @return The created tutorial or status indicating an error.
   */
   ...
   * @return The updated tutorial or status indicating not found/error.
   */
   ...
   * @return Status indicating the completion of the deletion.
   */
   ...
   *
   * @return List of published tutorials or status indicating no content.
   */
